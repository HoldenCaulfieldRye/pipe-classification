...
# static linking, we will statically link against CUDA and CUDART
  ifeq ($(USEDRVAPI),1)
      NVIDIAVER =  $(shell /bin/grep --max-count=1 -o -P 'NVIDIA dlloader X Driver  ([0-9]*)' /var/log/Xorg.0.log | sed 's/NVIDIA dlloader X Driver  //')
      NVIDIALIBDIR = /data/$(shell whoami)/shared/lib
      LIB += -L/usr/lib/nvidia-$(NVIDIAVER) -L$(NVIDIALIBDIR) -lcuda  ${OPENGLLIB} $(PARAMGLLIB) $(RENDERCHECKGLLIB) $(CUDPPLIB) ${LIB} 
  else
