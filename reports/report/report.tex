...
One would be tempted to conjecture that the steepness of the error surface along these dimensions decreases with the extent of class imbalance, and approaches 0 as class imbalance approaches 100\%. 

Also, another interesting observation that remains unexplained is the reason for why the validation error improves smoothly but the validation accuracy improves incrementally, discontinuously. Further analysis and experimentation would perhaps make for interesting further work.\\
