...
The literature on deep learning with class imbalance was found to be scarce. `Training cost sensitive neural networks with methods addressing the class imbalance problem' by Zhou and Liu, 2005, covers the same three approaches as `Learning when data sets are imbalanced and when costs are unequal and unknown' by Maloof, 2003. `'
...
These results are encouraging and further experiments with benchmark multi-class datasets such as MNIST, CIFAR and ImageNet would allow to situate the 
