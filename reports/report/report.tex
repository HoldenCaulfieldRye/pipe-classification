...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/plot_clampdet_conv2.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/plot_clampdet_conv3.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/plot_clampdet_conv5.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/plot_clampdet_fc6.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/plot_clampdet_fc7.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth, natwidth=610,natheight=642]{images/plot_clampdet_none.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}

%\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth, natwidth=610,natheight=642]{images/plot_clampdet_us_none.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}
