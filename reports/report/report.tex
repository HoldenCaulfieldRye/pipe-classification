...
Over-sampling rebalances the training set to desired levels of imbalance by removing majority class examples. The brute force approach, implemented in (Maloof 2003) \cite{maloof}, is to randomly remove these cases and train on the remaining set.
...
Instead, brute force under-sampling was implemented as in (Maloof 2003) \cite{maloof}. Results are shown below.
