...
The bulk of research undertaken to make more general improvements in understanding deep learning and dealing with class imbalance, combined with time constraints, have restricted the time spent optimising each one of ControlPoint's tasks. For the moment, 3 tasks have per class accuracy in the 85-90\% range, 2 in the 75-80\% range, 1 at 62\%, 2 have been found impossible to train and 2 others have not been attempted. However, the recent discovery of the novel cost function means that it was only implemented for one of these tasks; these scores are therefore likely to increase significantly thanks to this straightforward improvement alone.
}
\end{abstract}
...
\begin{table}[h!]
   \centering
    ...
    Joint Misalignment  & ~ 35     & ~     & ~    & ~ N/A     & ~ N/A \\
    Fitting Proximity   & ~ 32     & ~ X   & ~    & ~ N/A     & ~ N/A \\
    \hline
    \end{tabular}
