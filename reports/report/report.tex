...
\begin{table}[h!]
   \centering
    \begin{tabular}{|l|c|c|}
    \hline
    Model                                & ~ Redbox Count  & ~ Bluebox Count  \\ 
    \hline
    No transfer learning                          & ~  1,233        & ~ 32      \\
    No transfer learning \textit{with threshold}  & ~  1,233        & ~ 32      \\
    \hline
    Full transfer backprop                   & ~ 1,401         & ~ 83      \\
    Full transfer backprop  \textit{with threshold}  & ~ 1,401         & ~ 83      \\
    \hline
    \end{tabular}
