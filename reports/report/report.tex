...
In order to impose convolution i.e.\ application of the same kernel over the entire image, the learning rule \eqref{eqn:learning_rule} given in section \\

Note that this subsection on explaining sliding kernels is heavily inspired from a blog post by Christopher Colah \cite{colah}.
