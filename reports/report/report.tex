...
The bulk of research undertaken to make more general improvements in understanding deep learning and dealing with class imbalance, combined with time constraints, have restricted the time spent optimising each one of the 10 tasks. For the moment, 3 tasks have per class accuracy in the 88-90\% range, 2 in the 75-80\% range, 1 at 62\%, and 4 have been found impossible to train. However, the recent discovery of the novel cost function means that it was only implemented for 3 of these tasks; these scores are therefore likely to increase significantly thanks to this straightforward improvement alone.
}
\end{abstract}
