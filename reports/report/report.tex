...
The plot on figure ~\ref{f69} shows a model trained with this learning rate between the 5,000th and 10,000th iterations. The training error still does not decrease, and its amplitude remains high. This strongly suggests that 
