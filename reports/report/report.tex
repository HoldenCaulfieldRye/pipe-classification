...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
      ...
      \end{subfigure} \par \vspace*{20pt} % ...remove them from here
      \caption{Softmax Bayesian Cross Entropy by itself}\label{fig:2}
    \end{minipage}%
\end{figure}


\paragraph{Remove Pooling, a FC layer and add Softmax Bayesian Cross Entropy}
%     soil_contam/nopool                       TRAINING
\begin{figure}
    \centering
    \begin{minipage}[b]{\textwidth}
      ...
      \begin{subfigure}{.5\textwidth} 
        ...
        \caption{Bayesian cross entropy}\label{fig:2b}
      \end{subfigure} \par \vspace*{20pt} % ...remove them from here
      \caption{Softmax Bayesian Cross Entropy combined with Less Pooling}\label{fig:2}
    \end{minipage}%
\end{figure}
