...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{images/undersampling_algo.png}
	\caption{Clamp Detection, Full Backpropagation}
\end{figure}
