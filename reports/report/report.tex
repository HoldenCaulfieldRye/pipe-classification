...
\begin{figure}[h]       
    \fbox{\includegraphics[scale=0.28]{images/plot_markings-fine_01-08-2014.png}}   
    \hspace{30px}
    \fbox{\includegraphics[scale=0.28]{images/kernel_edge_enhance.png}}
    \hspace{30px}
    \fbox{\includegraphics[scale=0.28]{images/kernel_edge_enhance_result.png}}
    \caption{Image, kernel and resulting kernel map (source: convmatrix Gip documentation}
    \label{f21}
\end{figure}
